...
while (choice != "6") // The choice is currently null. When the user selects an option we want to keep running the below until a valid option is chosen. So WHILE the user entered something other than "5" on his keyboard...
{
